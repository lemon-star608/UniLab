...
class TestComputeRewards:
    ...
    def _make_mock_env(num_envs: int):
        ...
        env = MagicMock()
        env.cfg.reward.lifting_bonus_threshold = 0.15
        env.cfg.reward.lifting_bonus = 300.0
        env.cfg.reward.lifting_rew_scale = 20.0
        env.cfg.reward.distance_delta_rew_scale = 50.0
        env.cfg.reward.keypoint_rew_scale = 200.0
